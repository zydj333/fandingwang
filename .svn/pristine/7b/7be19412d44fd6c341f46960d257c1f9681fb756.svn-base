<div class="container">
    ...
    <div class="list-group col-lg-12">
        <div class="list-group-item col-lg-12">
            <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>mobile/support">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" id="buy_number" name="buy_number" value="1"/>
                </div>
                <div class="form-group">
                    <label>总金额：<small id="amount">¥<?php echo $items->price; ?>元</small></label>
                </div>
                <div class="form-group">
                    <label>配送邮费：<small>
                ...
                <input type="hidden" id="items_id" name="items_id" value="<?php echo $items->id; ?>">
                        ...
                        <?php if (!empty($address)): ?>
                            <?php foreach ($address as $add_key => $add_value): ?>
                                <div class="radio"><label>
                                        <input type="radio" name="address" id="address_<?php echo $add_value->id; ?>" value="<?php echo $add_value->id; ?>" <?php if ($add_value->is_default == 1): ?>checked="checked"<?php endif; ?> > 
                ...
                <button type="submit" class="btn btn-success btn-block">确认订单</button>
            </form>
        </div>
    </div>
</div>
