         ...
         //搜索
           ...
           function getPageUrl(nowpage){
               ...
               $.ajax({
                        ...
                        data: {'nowpage':nowpage,'project_name':project_name,'project_type':project_type,'is_success':is_success,'is_del':is_del},
                        dataType:"json",
                        success: function(data){
                            ...
                            str+='<td>';
                            if(values.is_effect==1){str+='是';}else{str+='<span style="color:red">否</span>';}str+='</td>';
                            str+='<td>';
                            ...
                            str+='<td>';
                                str+='<a onclick="return confirm(\'你确定恢复吗？\')" href="/admin_project/recover/'+values.id+'" class="tablelink">恢复</a>';
                            str+='</td>';
                        str+='</tr>';
                                });
                            }
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td><?php if($values->is_effect==1){echo'是';}else{echo '<span style="color:red">否</span>';} ?></td>
                            ...
                            <td>
                                <a onclick="return confirm('<?php echo lang('recover_notice'); ?>')" href="<?php echo base_url(); ?>admin_project/recover/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('recover'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
