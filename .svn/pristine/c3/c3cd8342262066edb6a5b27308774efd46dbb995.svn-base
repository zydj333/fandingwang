    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_projecttype/index"><?php echo lang('page_where_list'); ?></a></li>
            </ul>
        </div>
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                    <li class="click"><a href="<?php echo base_url(); ?>admin_projecttype/add"><span><img src="<?php echo base_url(); ?>images/backend/t01.png" /></span><?php echo lang('add'); ?></a></li>
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td> <a href="<?php echo base_url(); ?>admin_projecttype/edit/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('edit'); ?></a>
                            </td>
                        </tr>
                  <?php endforeach; ?>
                    </tbody>
