    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_projecttype/edit/<?php echo $type->id;?>"><?php echo lang('page_where_edit'); ?></a></li>
            </ul>
        </div>
        <div class="formbody">
            <form name="system_add_save" action="<?php echo base_url(); ?>admin_projecttype/edit/<?php echo $type->id;?>" method="post" id="system_add_save" enctype="multipart/form-data" >
