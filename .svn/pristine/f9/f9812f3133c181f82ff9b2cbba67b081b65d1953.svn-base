               ...
               $.ajax({
                        ...
                        success: function(data){
                            ...
                            str+='<td>';
                                ...
                                str+='<a onclick="return confirm(\'你确定要恢复此信息？\')" href="/admin_product/recover/'+values.id+'" class="tablelink">恢复</a>';
                            str+='</td>';
                        str+='</tr>';
                                });
                            }
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('<?php echo lang('recover_notice'); ?>')" href="<?php echo base_url(); ?>admin_product/recover/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('recover'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
