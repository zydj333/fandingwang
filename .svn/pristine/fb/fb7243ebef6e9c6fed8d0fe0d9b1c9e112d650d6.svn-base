...
<?php if (!empty($banner)): ?>
    ...
    <!--END-->
    <!--海报START-->
    <div class="probanner" id="ban" style="background:url(<?php echo base_url(); ?>images/projects_banner.jpg) no-repeat center top">
        <div class="box">
            <ul>
...
<div class="prolaunch">
    <div class="box">
        ...
        <a class="but" href="<?php echo base_url(); ?>launch">发起众筹</a>
    </div>
</div>
<!--END-->
...
<div class="project">
    <div class="box">
        ...
        <div class="nav">
            <ul class="left">
                <li <?php if ($status == 0): ?>class="now"<?php endif; ?>><a href="<?php echo base_url() . 'project/index/0/' . $type; ?>">最新</a></li>
                <li <?php if ($status == 1): ?>class="now"<?php endif; ?>><a href="<?php echo base_url() . 'project/index/1/' . $type; ?>">预热</a></li>
                <li <?php if ($status == 2): ?>class="now"<?php endif; ?>><a href="<?php echo base_url() . 'project/index/2/' . $type; ?>">已成功</a></li>
                <li <?php if ($status == 3): ?>class="now"<?php endif; ?>><a href="<?php echo base_url() . 'project/collect' ?>">收藏</a></li>
            </ul>
            <ul class="right">
                <!--<li class="hot">热门标签</li>-->
                <li <?php if ($type == 0): ?>class="now"<?php endif; ?>><a href="<?php echo base_url() . 'project/index/' . $status; ?>">全部</a></li>
                <?php if (!empty($pro_type)): ?>
                    <?php foreach ($pro_type as $pro_type_key => $pro_type_values): ?>
                        <li <?php if ($pro_type_values->id == $type): ?>class="now"<?php endif; ?>><a href="<?php echo base_url() . 'project/index/' . $status . '/' . $pro_type_values->id; ?>"><?php echo $pro_type_values->title; ?></a></li>
                    <?php endforeach; ?>
                <?php endif; ?>
            </ul>
            <div class="clear"></div>
