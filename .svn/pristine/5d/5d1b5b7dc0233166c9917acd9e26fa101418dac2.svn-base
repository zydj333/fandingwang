        ...
        <script type="text/javascript" >
            $(document).ready(function(e) {
                ...
                $("#add").click(function(){
                    $.ajax({
                        type: "POST",
                        url: "/admin_admessage/add/"+Math.random(),
    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_admessage/add"><?php echo lang('page_where_add'); ?></a></li>
            </ul>
        </div>
        <div class="formbody">
            <form name="system_add_save" action="<?php echo base_url(); ?>admin_admessage/add" method="post" id="system_add_save" enctype="multipart/form-data" >
            <div class="formtitle"><span><?php echo lang('add'); ?></span></div>
            <ul class="forminfo">
                <li><label><?php echo lang('cellphone'); ?></label><textarea name="user_name" cols="" rows="" class="textinput"></textarea></li>
