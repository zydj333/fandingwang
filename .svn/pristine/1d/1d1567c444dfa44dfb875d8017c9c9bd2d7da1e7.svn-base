...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>js/backend/jsapi.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/backend/format+zh_CN,default,corechart.I.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/backend/jquery.gvChart-1.0.1.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/backend/jquery.ba-resize.min.js"></script>
            ...
            <div class="mainleft">
                ...
                <div class="leftinfos">
                    ...
                    <div class="inforight">
                        ...
                        <ul class="tooli">
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d01.png" /></span><p><a href="#">信息资料</a></p></li>
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d02.png" /></span><p><a href="#">编辑</a></p></li>
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d03.png" /></span><p><a href="#">记事本</a></p></li>
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d04.png" /></span><p><a href="#">任务日历</a></p></li>
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d05.png" /></span><p><a href="#">图片管理</a></p></li>
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d06.png" /></span><p><a href="#">交易</a></p></li>
                            <li><span><img src="<?php echo base_url(); ?>images/backend/d07.png" /></span><p><a href="#">档案袋</a></p></li>
                        </ul>
                    </div>
                </div>
            </div>
