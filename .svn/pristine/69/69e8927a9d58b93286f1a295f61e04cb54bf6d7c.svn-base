    ...
    <head>
        ...
        <script type="text/javascript">
           ...
           function getPageUrl(nowpage){
               $.ajax({
                        type: "POST",
                        url: "/admin_bbstopic/ajaxList/"+Math.random(),
                        ...
                        success: function(data){
                            ...
                            str+='<td>'+values.forum_onename+'</td>';
                            str+='<td>'+values.forum_twoname+'</td>';
                            str+='<td>'+values.views+'</td>';
                            str+='<td>'+values.reply+'</td>';
                            ...
                            str+='<td>';
                                str+='<a href="/admin_bbstopic/edit/'+values.id+'" class="tablelink">修改</a> ';
                                str+='<a onclick="return confirm(\'你确定删除吗？\')" href="/admin_bbstopic/del/'+values.id+'" class="tablelink">删除</a>';
                            str+='</td>';
                        str+='</tr>';
                                });
                            }
    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_bbtospic"><?php echo lang('page_where_middle'); ?></a></li>
                <li><a href="<?php echo base_url(); ?>admin_bbstopic/index"><?php echo lang('page_where_list'); ?></a></li>
            </ul>
        </div>
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                    <li class="click"><a href="<?php echo base_url(); ?>admin_bbstopic/add"><span><img src="<?php echo base_url(); ?>images/backend/t01.png" /></span><?php echo lang('add'); ?></a></li>
            ...
            <table class="tablelist">
                <thead>
                    <tr>
                        ...
                        <th><?php echo lang('forum_onename'); ?></th>
                        <th><?php echo lang('forum_twoname'); ?></th>
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td><?php echo $values->forum_onename; ?></td>
                            <td><?php echo $values->forum_twoname; ?></td>
                            ...
                            <td> <a href="<?php echo base_url(); ?>admin_bbstopic/edit/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('edit'); ?></a>
                                <a onclick="return confirm('<?php echo lang('delete_notice'); ?>')" href="<?php echo base_url(); ?>admin_bbstopic/del/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('del'); ?></a>
                            </td>
                        </tr>
                  <?php endforeach; ?>
                    </tbody>
