         ...
         //搜索
           ...
           function getPageUrl(nowpage){
               ...
               $.ajax({
                        ...
                        data: {'nowpage':nowpage,'project_name':project_name,'project_type':project_type,'is_success':is_success,'is_effect':is_effect},
                        dataType:"json",
                        success: function(data){
                            ...
                            str+='<td>';
                                str+='<a href="/admin_project/passWaiting/'+values.id+'" class="tablelink">通过</a> | ';
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>admin_project/passWaiting/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('pass'); ?></a> | 
