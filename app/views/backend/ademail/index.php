        ...
        <script type="text/javascript">
         ...
         //搜索
           ...
           function getPageUrl(nowpage){
               ...
               $.ajax({
                        type: "POST",
                        url: "/admin_ademail/ajaxList/"+Math.random(),
                        data: {'nowpage':nowpage,'email':email,'title':title,'status':status},
                        dataType:"json",
                        success: function(data){
                            ...
                            str+='<td>';
                                str+='<a onclick="return confirm(\'你确定要重置并重新发送此信息？\')" href="/admin_ademail/reset/'+values.id+'" class="tablelink">重置</a>/';
                                str+='<a onclick="return confirm(\'你确定要删除此信息？\')" href="/admin_ademail/del/'+values.id+'" class="tablelink">删除</a>';
                            str+='</td>';
                        str+='</tr>';
                                });
                            }
    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_ademail/index"><?php echo lang('page_where_list'); ?></a></li>
            </ul>
        ...
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                    <li class="click"><a href="<?php echo base_url(); ?>admin_ademail/add"><span><img src="<?php echo base_url(); ?>images/backend/t01.png" /></span><?php echo lang('add'); ?></a></li>
                ...
                <ul class="seachform">
                    <li><label><?php echo lang('email'); ?></label><input name="email" id="cellphone" type="text" class="scinput" /></li>
                    <li><label><?php echo lang('title'); ?></label><input name="title" id="cellphone" type="text" class="scinput" /></li>
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td>
                                <a onclick="return confirm('<?php echo lang('reset_conform'); ?>')" href="<?php echo base_url(); ?>admin_ademail/reset/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('reset'); ?></a>/
                                <a onclick="return confirm('<?php echo lang('del_conform'); ?>')" href="<?php echo base_url(); ?>admin_ademail/del/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('del'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
