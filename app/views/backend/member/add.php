    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_member/add"><?php echo lang('page_where_add'); ?></a></li>
            </ul>
        </div>
        <div class="formbody">
            <form name="system_add_save" action="<?php echo base_url(); ?>admin_member/add" method="post" id="system_add_save" enctype="multipart/form-data" >
            ...
            <ul class="forminfo">
                ...
                <li><label>密码</label><input name="password" type="text" class="dfinput" value="123456"  style="width:150px;"/></li>
