    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_activity/index"><?php echo lang('page_where_list'); ?></a></li>
            </ul>
        </div>
        <div class="rightinfo">
            <div class="tools">
                <ul class="toolbar">
                    <li class="click"><a href="<?php echo base_url(); ?>admin_activity/add"><span><img src="<?php echo base_url(); ?>images/backend/t01.png" /></span><?php echo lang('add'); ?></a></li>
            ...
            <table class="tablelist">
                <thead>
                    <tr>
                        ...
                        <th><?php echo lang('dealtime'); ?></th>
                        <th><?php echo lang('views'); ?></th>
                        <th><?php echo lang('enlists'); ?></th>
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td><?php echo $values->dealtime; ?></td>
                            <td><?php echo $values->views; ?></td>
                            <td><?php echo $values->enlists; ?></td>
                            <td><?php echo $values->salt; ?></td>
                            <td><?php echo $values->adder; ?></td>
                            <td><?php if($values->is_del){echo '<a style="color:red" >是</a>';}else{echo '否';}; ?></td>
                            <td><?php echo $values->addtime; ?></td>
                            <td>
                                <a href="<?php echo base_url(); ?>admin_activity/detial/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('detial'); ?></a>
                                <a href="<?php echo base_url(); ?>admin_activity/enlist/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('enlist'); ?></a>
                                <a href="<?php echo base_url(); ?>admin_activity/edit/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('edit'); ?></a>  
                                <a onclick="return confirm('<?php echo lang('delete_notice'); ?>')" href="<?php echo base_url(); ?>admin_activity/del/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('del'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
