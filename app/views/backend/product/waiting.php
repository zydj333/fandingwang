           ...
           function getPageUrl(nowpage){
               ...
               $.ajax({
                        ...
                        success: function(data){
                            ...
                            str+='<td>';
                            if(values.is_effect==1){str+='是';}else{str+='<p style="color:red">否</p>';}str+='</td>';
                            str+='<td>';
                            ...
                            str+='<td>';
                                ...
                                str+='<a onclick="return confirm(\'你确定要通过此信息？\')" href="/admin_product/pass/'+values.id+'" class="tablelink">通过</a>';
                            str+='</td>';
                        str+='</tr>';
                                });
                            }
                ...
                <?php if (!empty($list)): ?>
                    ...
                    <?php foreach ($list as $key => $values): ?>
                        <tr align="left">
                            ...
                            <td><?php if($values->is_effect==1){echo'是';}else{echo '<p style="color:red">否</p>';} ?></td>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('<?php echo lang('pass_notice'); ?>')" href="<?php echo base_url(); ?>admin_product/pass/<?php echo $values->id; ?>" class="tablelink"><?php echo lang('pass'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
