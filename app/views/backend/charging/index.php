    ...
    <body>
        ...
        <div class="rightinfo">
            <div id="usual1" class="usual">
                <div class="itab">
                    <ul>
                        <li><a href="<?php echo base_url(); ?>admin_charging/index" class="selected"><?php echo lang('page_where_list'); ?></a></li>
            ...
            <ul class="seachform">
                <li><label><?php echo lang('charging_ns'); ?></label><input name="charging_ns" id="charging_ns" type="text" class="scinput" /></li>
