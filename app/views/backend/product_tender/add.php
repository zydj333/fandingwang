        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#add").click(function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/admin_product_tender/add/"+Math.random(),
    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_product_tender/add/<?php echo $product_id;?>"><?php echo lang('page_where_add'); ?></a></li>
            </ul>
        </div>
        <div class="formbody">
            <form name="system_add_save" action="<?php echo base_url(); ?>admin_product_tender/add/<?php echo $product_id;?>" method="post" id="system_add_save" enctype="multipart/form-data" >
                ...
                <ul class="forminfo">
                    ...
                    <li><label><?php echo lang('feed'); ?></label><textarea name="feed" id="editor_id" cols="" rows="" style="width:700px;height:300px;"></textarea></li>
