        ...
        <script type="text/javascript">
            $(document).ready(function(e) {
                ...
                $("#add").click(function(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/admin_bbstopic/add/"+Math.random(),
    ...
    <body>
        <div class="place">
            ...
            <ul class="placeul">
                ...
                <li><a href="<?php echo base_url(); ?>admin_bbstopic/add"><?php echo lang('page_where_add'); ?></a></li>
            </ul>
        </div>
        <div class="formbody">
            <form name="system_add_save" action="<?php echo base_url(); ?>admin_bbstopic/add" method="post" id="system_add_save" enctype="multipart/form-data" >
                ...
                <ul class="forminfo">
                    ...
                    <?php if(!empty($tag)):?>
                        ...
                        <input name="tags[]" type="checkbox" value="<?php echo $v->id; ?>" /><?php echo $v->tagname; ?>&nbsp;
                        <?php endforeach;?>
                    <?php endif;?>
                    </li>
