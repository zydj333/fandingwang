        ...
        <div class="right">
            <?php if (!empty($list)): ?>
                <?php foreach ($list as $list_key => $list_values): ?>
                    <div class="item">
                        <div class="ti"><a href="<?php echo base_url(); ?>shequ/ndsdetial/<?php echo $list_values->id; ?>"><?php echo $list_values->title; ?></a></div>
                        <div class="con"><a href="<?php echo base_url(); ?>shequ/ndsdetial/<?php echo $list_values->id; ?>"><?php echo $list_values->discription; ?></a></div>
                        <div class="pic"><a href="<?php echo base_url(); ?>shequ/ndsdetial/<?php echo $list_values->id; ?>"><img src="<?php echo base_url() . $list_values->imageurl; ?>" onerror="this.onerror='';this.src='<?php echo base_url(); ?>images/share_02.jpg'" width="348px" height="250px" /></a></div>
                        <div class="count">
