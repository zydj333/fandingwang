...
<div class="member">
    <div class="box">
            ...
            <div class="block">
                <div class="nav">
                    <ul>
                        ...
                        <li class="now"><a href="<?php echo base_url();?>usercenter/index">收藏的项目（<?php echo count($product);?>）</a></li>
                    </ul>
                </div>
                    <div class="proti">
        ...
        <div class="right">
            <div class="block">
                <div class="head">
                    <img  src="<?php echo base_url().$member->avatar;?>" onerror="this.onerror='';this.src='<?php echo base_url();?>images/avatar.jpg'" width="55px" /><br /><?php echo $member->username;?>
                </div>
                <dl>
