<div class="main">
    <div class="box">
        <div class="step-mod">
            ...
            <form action="<?php echo base_url(); ?>order/saveStepOne" method="post">
                <div class="body body6">
                    <ul class="form-ul">
                        <li>
                            ...
                            <input type="hidden" id="items_id" value="<?php echo $items->id; ?>" name="items_id" />
                            <input type="hidden" id="product_id" value="<?php echo $items->pid; ?>" name="product_id" />
                            <input type="hidden" id="product_name" value="<?php echo $product->title; ?>" name="product_name" />
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="txt" style="line-height:28px; padding-top:6px;">
                                <input type="number" class="text" id="bynumber" value="1" name="bynumber" style="width: 80px;" />总金额￥:<nobr style="color: red;" id="total_amount"><?php echo $items->price; ?>元</nobr>
                            </div>
                        </li>
                        <li>
                            <label for="">备注</label>
                            <textarea name="suggest" class="text textarea" style="height:60px;" placeholder="你想对项目发起者说的话"></textarea>
                        </li>
                    </ul>
                    <div class="line"></div>
                    <ul class="form-ul">
                        ...
                        <div  id="addres_list">
                            <?php if (!empty($address)): ?>
                                ...
                                <li>
                                    <label></label>
                                    <input type="radio"  id="address_<?php echo $add->id; ?>" value="<?php echo $add->id; ?>" name="address" <?php if ($add->is_default == 1): ?>checked="checked"<?php endif; ?> />
